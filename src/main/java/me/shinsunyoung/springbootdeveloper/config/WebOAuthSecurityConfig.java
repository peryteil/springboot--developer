        ...
        return http
                ...
                .authorizeRequests(auth -> auth
                        .requestMatchers(
                                ...
                                "/css/**",
                                "/js/**",
                                "/.well-known/**",package me.shinsunyoung.springbootdeveloper.config;
...
public class WebOAuthSecurityConfig {
    ...
    @Bean
    public WebMvcConfigurer corsConfigurer() {package me.shinsunyoung.springbootdeveloper.config;
